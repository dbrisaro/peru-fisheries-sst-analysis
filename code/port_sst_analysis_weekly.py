...
output_dir = 'results/port_sst_analysis_weekly'
...
# Calcular regresión con datos semanales
results_regression = calculate_landing_sst_anomaly_regression(df_prod_weekly, port_data_sst_weekly)
results_regression_df = pd.DataFrame(results_regression)
results_regression_df.to_csv(f'{output_dir}/data/results_regression_weekly.csv')
