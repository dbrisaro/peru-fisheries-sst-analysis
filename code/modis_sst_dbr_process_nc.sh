...
INPUT_DIR="../data/MODIS/raw"      # Carpeta con archivos originales
OUTPUT_DIR="../data/MODIS/processed"  # Carpeta donde guardamos los resultados
...
MERGED_FILE="$OUTPUT_DIR/sst_merged_daily_complete.nc"
